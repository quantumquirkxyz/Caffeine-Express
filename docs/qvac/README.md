...
- [**#5 — QVAC: typed MVP extraction contract**](https://github.com/quantumquirkxyz/Caffeine-Express/issues/5)
...
- [**#9 — QVAC: configure MVP text-generation model and smoke test**](https://github.com/quantumquirkxyz/Caffeine-Express/issues/9)
